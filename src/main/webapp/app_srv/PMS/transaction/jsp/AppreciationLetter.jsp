...
<section id="main-content" class="main-content merge-left">
	...
	<div class=" col-md-12 pad-top-double  text-left">
		<ol class="breadcrumb bold">
			...
			<li class="active">Appreciation Letter</li>
		</ol>
	</div>
</div>
<div class="row ">
		...
		<form:form id="form1" modelAttribute="appreciationLetterModel" action="/PMS/saveUpdateAppreciation" method="post">
			<form:hidden path="numAppreciationID"/>
	...
	<div class="container ">
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="panel panel-info panel-info1">
					<div class="panel-heading panel-heading-fd"><h4 class="text-center ">Appreciation Letter</h4></div>
				...
				<div class="row pad-top ">
							...
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								...
								<label class="label-class"><spring:message code="Appreciation_Letter.Description"/>:<span
							...
							<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									...
									<form:textarea class="input-field" path="strDescription" placeholder="Description of Appreciation Letter"/>
					...
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group col-md-push-3 col-sm-push-2">
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								<label class="label-class" ><spring:message code="Appreciation_Letter.Appreciated"/>:<span
									style="color: red;">*</span> </label>
							</div> 
						<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
						...
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group col-md-push-3 col-sm-push-2">
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								<label class="label-class" ><spring:message code="Appreciation_Letter.date"/>: <span
									style="color: red;">*</span></label>
							</div>
							...
							<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									<i class="fa fa-calendar icon"></i>
									 <form:input class="input-field" readonly='true' path="dateOfAppreciation" placeholder="Date of Appreciation Letter"/>							
								<form:errors path="dateOfAppreciation" cssClass="error" />
								</div>
							</div>
					...
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group col-md-push-3 col-sm-push-2">
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								<label class="label-class" ><spring:message code="Appreciation_Letter.Recipient"/>:<span
									style="color: red;">*</span> </label>
							</div> 
						<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									<i class="fa fa-file-text-o icon "></i>
									<form:input class="input-field"  path="strRecipientName" placeholder="Recipient Name"/>
									<form:errors path="strRecipientName" cssClass="error" />
								</div>
							</div>
						</div>
						</div>		
    ...
    var chkArray = [];
		    ...
		    if(selected.length >= 1){
		    	 ...
		    	 swal({
				      ...
				      if (isConfirm) {
					    	  $("#numAppreciationID").val(selected);
...
function submit_form_delete()
{
 ...
 document.getElementById("form1").action = "/PMS/deleteAppreciation";
				...
				<tbody class="ui-sortable">
						<c:forEach items="${data}" var="copy" varStatus="loop">
					 	<tr id="row-${loop.index}">
							<td align="center"><input type="checkbox" class="CheckBox" id="Checkbox" value="${copy.numAppreciationID}" autocomplete="off"></td>
							<td align="center">${loop.count}</td>
							
							<td class="hidden">${copy.numAppreciationID}</td>
							<td>${copy.strDescription}</td>
						    <td>${copy.strAppreciaitionAgency}</td>
						    <td>${copy.dateOfAppreciation}</td>
						    <td>${copy.strRecipientName}</td>
...
<script type="text/javascript" src="/PMS/resources/app_srv/PMS/transaction/js/AppreciationLetter.js"></script>
