...
<section id="main-content" class="main-content merge-left">
	...
	<div class=" col-md-12 pad-top-double  text-left">
		<ol class="breadcrumb bold">
			...
			<li class="active">Expenditure Head Master</li>
		</ol>
	</div>
</div>
<div class="row ">
		 ...
		 <sec:authorize access="hasAuthority('WRITE_EXPENDITURE_HEAD_MST')"> 
		<form:form id="form1" modelAttribute="expenditureHeadModel" action="/PMS/mst/saveUpdateExpenditureHead" method="post">
			<form:hidden path="numId"/>
			<form:hidden path="idCheck"/>
	<div class="container ">
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="panel panel-info panel-info1">
					<div class="panel-heading panel-heading-fd"><h4 class="text-center ">Expenditure Head Master</h4></div>
				...
				<div class="row pad-top ">
							...
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								...
								<label class="label-class"><spring:message code="expenditure_Head.expenditure_Head_Name"/>:<span
										...
										<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
											<div class="input-container">
												...
												<form:input class="input-field"
													path="strExpenditureHeadName" />
												<form:errors path="strExpenditureHeadName" cssClass="error" />
											</div>
										</div>
									</div>
	...
	<div class=" datatable_row pad-bottom">
	   ...
	   $(document).ready(function() {
			...
			$('#delete').click(function(){
				ExpenditureHeadDelete();
			});
		});
	  
	  		 
	  function ExpenditureHeadDelete(){
    var chkArray = [];
...
function submit_form_delete()
{
 ...
 document.getElementById("form1").action = "/PMS/mst/deleteExpenditureHead";
...
document.getElementById("form1").submit(); 
			...
			<table id="example" class="table table-striped table-bordered"
				...
				<thead class="datatable_thead bold ">
					<tr>
						...
						<th>Expenditure Head Name</th>	
						<th>Status</th>
						<th>Edit</th>
					</tr>
				</thead>
				<tbody class="">
					<c:forEach items="${data}" var="expenditureHeadModel">
						<tr>
						
						
							<td><input type="checkbox"  path="checkbox" class="CheckBox" id="Checkbox" value="${expenditureHeadModel.numId}" autocomplete="off">${expenditureHeadModel.numId}</td>
							<td>${expenditureHeadModel.strExpenditureHeadName}</td>
						
							
							
							
							<c:choose>
								<c:when test="${expenditureHeadModel.valid}">
									<td>Active</td>
								</c:when>
								<c:otherwise>
									<td>Inactive</td>
	...
	<script type="text/javascript" src="/PMS/resources/app_srv/PMS/master/js/expenditureHead.js"></script>
