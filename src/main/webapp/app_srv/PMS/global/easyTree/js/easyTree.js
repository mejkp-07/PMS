...
(function ($) {
    $.fn.EasyTree = function (options) {
        var defaults = {
            ...
            addable: false,
            i18n: {
                deleteNull: 'Please select the item to delete.',
                deleteConfirmation: 'Are you sure you want to delete?',
                confirmButtonLabel: 'Confirm',
                editNull: 'Please select the item to edit.',
                editMultiple: 'You can only edit one item at a time',
        ...
        this.each(function () {
            ...
            $.each($(easyTree).find('ul > li'), function() {
                ...
                if($(this).is('li:has(ul)')) {
                    ...
                    $(children).remove();
                    text = $(this).text();
                    $(this).html('<span><span class="glyphicon"><a href="javascript: void(0);"></a> </span> </span>');
                    $(this).find(' > span > span').addClass('glyphicon-folder-open');
                    $(this).find(' > span > span > a').text(text);
            ...
            if (options.addable) {
                ...
                $(easyTree).find('.easy-tree-toolbar .create > button').attr('title', options.i18n.addTip).click(function () {
                    ...
                    $(createInput).find('.confirm').click(function () {
                        ...
                        var item = $('<li><span class="file_span"><span class="glyphicon glyphicon-file"></span><a href="javascript: void(0);">' + $(createInput).find('input').val() + '</a> </span></li>');
