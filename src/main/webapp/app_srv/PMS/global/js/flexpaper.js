...
window.FlexPaperViewerEmbedding = window.$f = function(id, args) {
    ...
    window[instance] = flashembed(id, {
    	src						    : "/CDSCO/resources/app_srv/cdsco/global/ViewPdf/magazine/FlexPaperViewer.swf",
        version					    : [10, 0],
        expressInstall			    : "/CDSCO/resources/app_srv/cdsco/global/ViewPdf/magazine/expressinstall.swf",
        wmode					    : _WMode
    },{
        ElementId               : id,
        SwfFile  				: _SWFFile,
        ...
        CursorToolsVisible 		: ((config.CursorToolsVisible!=null)?false:false),
