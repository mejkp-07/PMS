...
<body>
				...
				<div class=" col-md-12 pad-top-double  text-left">
					<ol class="breadcrumb bold">
						...
						<li class="active"><spring:message
								code="menu.employee.relieved.label" /></li>
					</ol>
				</div>
			</div>
			...
			<div class="panel-body">
				...
				<div class="row pad-top">
					...
					<div class="row pad-top">
						...
						<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12 form-group">
							<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
								<label class="label-class"><spring:message code="milestone.review.strRemarks"/>:</label>
							</div>
							<!-- <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
								<div class="input-container">
	...
	<script type="text/javascript"
		src="/PMS/resources/app_srv/PMS/master/js/relievedEmployee.js"></script>
