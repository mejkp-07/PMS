...
$(document).ready(function() {
	...
	$(document).on('click','#edit',function(e){
		...
		$('#strMilestoneTypeName').val(resultArray[1].trim());	
...
//	      live: 'disabled',
		excluded: ':disabled',
	      ...
	      fields: {
	    	  strMilestoneTypeName: {
	              group: '.col-md-12',
	              validators: {
	                  notEmpty: {
	                      message: 'Milestone Type Name is required and cannot be empty'
	                  },
	                  stringLength: {
	                        max: 250,
	                        message: 'Milestone Type Name  must be less than 250 characters'
	                    },
	                    regexp: {
	                        regexp: nameRegex,
