...
<div class="row ">
		...
		<form:form id="form1" modelAttribute="actionModel" action="/PMS/saveUpdateAction" method="post">
			<form:hidden path="numActionId"/>
			
	<div class="container ">
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="panel panel-info panel-info1">
					<div class="panel-heading panel-heading-fd"><h4 class="text-center "><spring:message code="Action.master"/></h4></div>
				...
				<div class="row pad-top ">
							...
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								...
								<label class="label-class"><spring:message code="Action.name"/>:<span
							...
							<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									...
									<form:input class="input-field" path="strName" placeholder="Action Name"/>
									<form:errors path="strName" cssClass="error" />
								</div>
							</div>
						</div>
						</div>
					...
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group col-md-push-3 col-sm-push-2">
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								<label class="label-class" ><spring:message code="Action.performed"/>:<span
									style="color: red;">*</span> </label>
							</div> 
						<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									<i class="fa fa-file-text-o icon "></i>
									<form:input class="input-field"  path="strActionPerformed" placeholder="Action Performed"/>
									<form:errors path="strActionPerformed" cssClass="error" />
								</div>
							</div>
						</div>
						</div>	
...
function submit_form_delete()
{
 ...
 document.getElementById("form1").action = "/PMS/deleteAction";
		...
		<table id="example" class="table table-striped table-bordered display select dataTable"
				...
				<thead class="datatable_thead bold ">
					...
					<tr id="row">
						...
						<th><spring:message code="Action.performed"/></th>
						<th>Status</th>
						<th>Edit</th>
					</tr>
				</thead>
				<tbody class="ui-sortable">
						<c:forEach items="${data}" var="copy" varStatus="loop">
					 	<tr id="row-${loop.index}">
							<td align="center"><input type="checkbox" class="CheckBox" id="Checkbox" value="${copy.numActionId}" autocomplete="off"></td>
							<td align="center">${loop.count}</td>
							<td class="hidden">${copy.numActionId}</td>
							<td>${copy.strName}</td>
						    <td>${copy.strActionPerformed}</td>
						    <c:choose>
...
<script type="text/javascript" src="/PMS/resources/app_srv/PMS/master/js/Action.js"></script>
