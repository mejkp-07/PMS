...
@Entity
@Audited
@AuditTable(value="pms_project_doc_detail_log",schema="pms_log")
@Table(name="pms_project_document_details")
public class ProjectDocumentDetailsDomain extends TransactionInfoDomain implements Serializable{/**
	 * 
	 */
    ...
    private ProjectDocumentMasterDomain projectDocumentMasterDomain;	
