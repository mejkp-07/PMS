...
<section id="main-content" class="main-content merge-left">
	...
	<div class=" col-md-12 pad-top-double  text-left">
		<ol class="breadcrumb bold">
			...
			<li class="active">Skill Master</li>
		</ol>
	</div>
</div>
<div class="row ">
		...
		<form:form id="form1" name="form1" modelAttribute="skillMasterModel" action="/PMS/mst/saveSkillMaster" method="post">
			<form:hidden path="numIds"/>
			<form:hidden path="numId"/>
			<div class="container ">
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="panel panel-info panel-info1">
					<div class="panel-heading panel-heading-fd"><h4 class="text-center "><spring:message code="master.skill"/></h4></div>
				...
				<div class="row pad-top ">
							...
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
							 ...
							 <div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									...
									<form:input class="input-field"  path="strSkillName"/>
									<form:errors path="strSkillName" cssClass="error" />
								</div>
							</div>
						</div>
						</div>
					...
					<div class="row pad-top  form_btn">
								<sec:authorize access="hasAuthority('WRITE_SKILL_MST')">	
...
<%--  						 <th class='hidden'><spring:message code="forms.status"/></th> 
 --%> 						<th><spring:message code="forms.edit"/></th>
				...
				<tbody class="">
					<c:forEach items="${data}" var="skillData">
						<tr>
						
							<td><input type="checkbox"  class="CheckBox" id="CheckBox"  value="${skillData.numId}" />${skillData.numId}</td>
							<td>${skillData.strSkillName}</td>
...
<script type="text/javascript" src="/PMS/resources/app_srv/PMS/master/js/SkillMaster.js"></script>
