...
@Entity
@Audited
@AuditTable(value="pms_end_user_master_log",schema="pms_log")
@Table(name="pms_end_user_master")
public class EndUserMasterDomain extends TransactionInfoDomain implements
		Serializable {
