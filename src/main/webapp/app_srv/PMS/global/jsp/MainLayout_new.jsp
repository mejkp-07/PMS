...
$(document).ready(function(){	
	...
	<!-- smooth scrolling -->
<!-- 	<script src="/PMS/resources/app_srv/PMS/global/js/new/SmoothScroll.min.js"></script> -->
	<!-- move-top -->
	<!-- <script src="/PMS/resources/app_srv/PMS/global/js/new/move-top.js"></script> -->
	<!-- easing -->
		<!-- <script src="/PMS/resources/app_srv/PMS/global/js/new/waypoints.min.js"></script> 
	<script src="/PMS/resources/app_srv/PMS/global/js/new/counterup.min.js"></script>  -->
	<!--Banner  -->
	<!-- <script src="/PMS/resources/app_srv/PMS/global/js/new/minimal-slider.js"></script>
...
<!-- <link rel="stylesheet" href="/PMS/resources/app_srv/PMS/global/upgraded/css/jquery-ui.css" />
	<link href="/PMS/resources/app_srv/PMS/global/upgraded/css/popuo-box.css" rel="stylesheet" type="text/css" media="all"/>  -->
<link href="/PMS/resources/app_srv/PMS/global/css/home.css"
	rel="stylesheet" type="text/css" media="all" />

<link rel="stylesheet" type="text/css"
	href="/PMS/resources/app_srv/PMS/global/css/mobile-homepage.css">
<link rel="stylesheet" type="text/css"
	href="/PMS/resources/app_srv/PMS/global/css/core.css">
<link rel="stylesheet" type="text/css"
	href="/PMS/resources/app_srv/PMS/global/css/responsive.css">
	<link rel="stylesheet" type="text/css"
	href="/PMS/resources/app_srv/PMS/global/css/minimal-slider.css">
<!-- code for favicon -->
