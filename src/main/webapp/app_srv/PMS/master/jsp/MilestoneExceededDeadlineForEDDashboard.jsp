...
<div class="panel panel-info panel-glance">
		...
		<!-- 		added the div for adding the from and to filter by varun on 05-07-2023 -->
					...
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 zero">
						 <!-- <div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 date-bar pad-bottom">  -->
			              ...
			              <!--  change the width to 43% by varun 0n 06-07-2023 -->
			  ...
			  <!--  change the width 32 to 43% by varun 0n 06-07-2023 -->
						...
						<!-- added the style by varun on 05-07-23 style="padding-top:25px;" -->
			...
			<table id="milestoneTable" class="table table-striped table-bordered mileDataTable"
				...
				<thead class="datatable_thead bold ">
					<tr>
						...
						<th width="15%"><spring:message code="dashboard.client.name"/></th>	 --%>					
