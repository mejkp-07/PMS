...
<link rel="stylesheet"
	href="/PMS/resources/app_srv/PMS/global/css/new/font-awesome.min.css">


<link rel="stylesheet"
	href="/PMS/resources/app_srv/PMS/master/css/validateBox.css">
...
<div class="row ">
		 ...
		 <sec:authorize access="hasAuthority('WRITE_ACTIVITY_MST')">  
		<form:form id="form1" modelAttribute="activityMasterModel" action="/PMS/mst/saveUpdateActivityMaster" method="post">
			<form:hidden path="numId"/>
			<form:hidden path="idCheck"/>
	<div class="container ">
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="panel panel-info panel-info1">
					<div class="panel-heading panel-heading-fd"><h4 class="text-center ">Activity Master</h4></div>
				...
				<div class="row pad-top ">
							...
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								...
								<label class="label-class"><spring:message code="activity_Master.activity_Name"/>:<span
										...
										<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
											<div class="input-container">
												...
												<form:input class="input-field"
													path="strActivityName" />
												<form:errors path="strActivityName" cssClass="error" />
											</div>
										</div>
									</div>
					...
					<div class="row pad-top ">
							...
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								...
								<label class="label-class"><spring:message code="activity_Master.subActivity_Name"/>:<span
									style="color: red;">*</span></label>
							</div>
										<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
										<div class="input-container">
											<form:select path="numSubActivityId"  multiple="true" id="numSubActivityId" class="select2Option">
												<c:forEach items="${subActivityList}"
													var="subActivityList">
													<form:option value="${subActivityList.numId}">
														<c:out value="${subActivityList.strSubActivityName}"></c:out>
													</form:option> 
												</c:forEach> 
											</form:select>
										</div>
	...
	<div class=" datatable_row pad-bottom">
	   ...
	   $(document).ready(function() {
			...
			$('#delete').click(function(){
				ActivityMasterDelete();
			});
		});
	  
	  		 
	  function ActivityMasterDelete(){
    var chkArray = [];
...
function submit_form_delete()
{
 ...
 document.getElementById("form1").action = "/PMS/mst/deleteActivity";
			...
			<table id="example" class="table table-striped table-bordered"
				...
				<thead class="datatable_thead bold ">
					<tr>
						...
						<th>Activity Name</th>
						<th class="hidden">Sub Activity</th>	
				...
				<tbody class="">
					<c:forEach items="${data}" var="activityMasterModel">
					
						<tr>
							<td><input type="checkbox"  path="checkbox" class="CheckBox" id="Checkbox" value="${activityMasterModel.numId}" autocomplete="off">${activityMasterModel.numId}</td>
							<td>${activityMasterModel.strActivityName}</td>
						
							<td class="hidden">${activityMasterModel.subActivityIds}</td>	
								<td>${activityMasterModel.subActivityNames}</td>	
							
							
							<c:choose>
								<c:when test="${activityMasterModel.valid}">
									<td>Active</td>
								</c:when>
								<c:otherwise>
									<td>Inactive</td>
...
<script
	...
	<script
	src="/PMS/resources/app_srv/PMS/global/js/DataTable/jquery.dataTables.min.js"></script>
<script
	src="/PMS/resources/app_srv/PMS/global/js/DataTable/dataTables.bootstrap4.min.js"></script>
  ...
  <script src="/PMS/resources/app_srv/PMS/global/js/jquery-ui.js"></script>
	...
	<script type="text/javascript" src="/PMS/resources/app_srv/PMS/master/js/ActivityMaster.js"></script>
