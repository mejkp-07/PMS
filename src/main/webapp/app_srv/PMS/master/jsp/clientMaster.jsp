...
<section id="main-content" class="main-content merge-left">
	...
	<div class=" col-md-12 pad-top-double  text-left">
		<ol class="breadcrumb bold">
			...
			<li class="active">Funding Organization Master</li>
		</ol>
	</div>
</div>
<div class="row ">
		...
		<form:form id="form1" modelAttribute="clientMasterModel" action="/PMS/mst/saveUpdateClientMaster" method="post">
			<form:hidden path="numId"/>
			<form:hidden path="referrerValue" value="${referrerValue}"/>
			<div class="container ">
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="panel panel-info panel-info1">
					<div class="panel-heading panel-heading-fd"><h4 class="text-center ">Funding Organization  Master</h4></div>
				...
				<div class="row pad-top ">
							...
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
									...
									<label class="label-class "><spring:message code="client.master.name"/> :<span
	...
	<script type="text/javascript" src="/PMS/resources/app_srv/PMS/master/js/clientMaster.js"></script>
