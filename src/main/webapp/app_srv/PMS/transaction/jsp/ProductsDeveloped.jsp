			...
			<div class="row">
				<div class=" col-md-12 pad-top-double  text-left">
					<ol class="breadcrumb bold">
						<li>Home</li>
						<li class="active">Products Developed</li>
					</ol>
				</div>
			</div>
			<div class="row "></div>
...
<%--          <div class="hidden" id="encCategoryId">${encCategoryId}</div> 
 --%>         
			...
			<form:form id="form1" name="form1" modelAttribute="productsDevelopedModel" action="/PMS/SaveProductsDeveloped" method="post">
				<form:hidden path="numId" id="numId" value="0"/>
				<form:hidden path="numIds" id="numIds" value=""/>
					<form:hidden path="strProductsDevelopedHtml" name="strProductsDevelopedHtml" id="strProductsDevelopedHtml" value=""/>
						<form:hidden path="strProductsDeveloped" name="strProductsDeveloped" id="strProductsDeveloped" value=""/>
					 <form:hidden path="encCategoryId" name="encCategoryId" id="encCategoryId" value="${categoryId}"/>
					...
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
						<div class="panel panel-info panel-info1">
							<div class="panel-heading panel-heading-fd">
								<h4 class="text-center ">Products Developed</h4>
							</div>
								...
								<div class="row">
									<div
										...
										<div class="col-md-4 col-lg-4 col-sm-4 col-xs-12 text-justify">
											...
											<!-- <label class="label-class">Products Developed
							...
							<button type="button" class="btn btn-success font_16" id="previewDetailsBtn">
						...
						<div class="row pad-top" id="mainPrevNext">
									...
									<div class="">
			<fieldset>
				 <legend class="info">List of Products Developed </legend>
				<div class="row">
				<div class="pull-right">
				 	...
				 	<table class="table table-bordered compact display hover stripe"  id="inboxTable"  data-page-size="5"  id="tab1">
...
<!-- 				         <th class="details-control" width="3%" ><input type="checkbox"></th>          
 -->                  <th width="3%"></th>
					...
					<tbody id="addRowData">
					 <%int i = 1 ;%>
					<c:forEach  items="${descrip}" var="list"> 
					<tr>
					<td><input type="checkbox" class="CheckBox" id="Checkbox" value="${list.numId}"></td>
					<td class="text-center"><%=i%></td>
					<td>${list.strProductsDevelopedHtml}</td>
					<td class="text-center"><div id="Edit"><input type="hidden"  value="${list.numId}" >								<span class="fa fa-pencil-square-o btn btn-primary a-btn-slide-text" id="edit" aria-hidden="true"></span></div></td>
					</tr>
					<%i++; %>
					 </c:forEach>
					</tbody>
	...
	<script type="text/javascript"
		src="/PMS/resources/app_srv/PMS/transaction/js/ProductsDeveloped.js"></script>
