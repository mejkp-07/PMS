...
<%--          <div class="hidden" id="encCategoryId">${encCategoryId}</div> 
 --%>			<form:form id="form1" modelAttribute="projectOthersModel" action=""
				method="post"> 
					<input type="hidden" name=strProjectOthersHtml id="strProjectOthersHtml" value="${descrip}"/>
	...
	<script type="text/javascript"
		src="/PMS/resources/app_srv/PMS/transaction/js/ProjectOthers.js"></script>
