...
<section id="main-content" class="main-content merge-left">
	...
	<div class=" col-md-12 pad-top-double  text-left">
		<ol class="breadcrumb bold">
			...
			<li class="active">MoUs/Collaborations</li>
		</ol>
	</div>
</div>
<div class="row ">
...
<%--          <div class="hidden" id="encCategoryId">${encCategoryId}</div>  --%> 
		<form:form id="form1" modelAttribute="mouCollaborationModel" action="/PMS/saveUpdateMouCollaboration" method="post">
			<form:hidden path="numCollabID"/>
	...
	<div class="container ">
		<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12">
				<div class="panel panel-info panel-info1">
					<div class="panel-heading panel-heading-fd"><h4 class="text-center ">MoUs/Collaborations</h4></div>
				...
				<div class="row pad-top ">
							...
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								...
								<label class="label-class"><spring:message code="Mou_Collaboration.Agency"/>:<span
							...
							<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									...
									<form:input class="input-field" path="strCollabAgency" placeholder="Agency"/>
									<form:errors path="strCollabAgency" cssClass="error" />
								</div>
							</div>
						</div>
						</div>
						...
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group col-md-push-3 col-sm-push-2">
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								<label class="label-class" ><spring:message code="Mou_Collaboration.FromDt"/>: <span
									style="color: red;">*</span></label>
							</div>
							...
							<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									<i class="fa fa-calendar icon"></i>
									 <form:input class="input-field" readonly='true' path="dtFromDate" placeholder="From Date"/>							
								<form:errors path="dtFromDate" cssClass="error" />
								</div>
							</div>
						...
						<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group col-md-push-3 col-sm-push-2">
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								<label class="label-class" ><spring:message code="Mou_Collaboration.ValidityDt"/>: <span
									style="color: red;">*</span></label>
							</div>
							...
							<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									<i class="fa fa-calendar icon"></i>
									 <form:input class="input-field" readonly='true' path="dtValidityDate" placeholder="Validity Date"/>							
								<form:errors path="dtValidityDate" cssClass="error" />
								</div>
							</div>
					...
					<div class="col-md-12 col-lg-12 col-sm-12 col-xs-12 form-group col-md-push-3 col-sm-push-2">
							<div class="col-md-2 col-lg-2 col-sm-6 col-xs-12 text-justify">
								<label class="label-class" ><spring:message code="Mou_Collaboration.Objective"/>:<span
									style="color: red;">*</span> </label>
							</div> 
						<div class="col-md-6 col-lg-6 col-sm-6 col-xs-12">
								<div class="input-container">
									<i class="fa fa-file-text-o icon "></i>
									<form:textarea class="input-field"  path="strObjective" placeholder="Objective/Purpose"/>
...
function submit_form_delete()
{
 ...
 document.getElementById("form1").action = "/PMS/deleteMouCollaboration";
		...
		<table id="example" class="table table-responsive table-bordered compact display hover stripe"
				...
				<thead class="datatable_thead bold ">
					...
					<tr id="row">
						...
						<th width="3%"></th>
						<th class="width10 check details-control">S.No.</th>
						<th class="hidden" ></th>
						<th class="control" width="50%">Agency</th>	
						<th class="control" width="20%">From Date</th>
						<th class="control" width="20%">Validity date</th>
						<th class="none">Objective/Purpose</th>
				...
				<tbody class="ui-sortable">
						<c:forEach items="${data}" var="copy" varStatus="loop">
					 	<tr id="row-${loop.index}">
							<td align="center"><input type="checkbox" class="CheckBox" id="Checkbox" value="${copy.numCollabID}" autocomplete="off"></td>
							<td></td>
							<td align="center">${loop.count}</td>
			<%-- 				<td class="hidden">${copy.numGroupCategoryId}</td> --%>
							<td class="hidden">${copy.numCollabID}</td>
							<td>${copy.strCollabAgency}</td>
						    <td>${copy.dtFromDate}</td>
						    <td>${copy.dtValidityDate}</td>
						    <td>${copy.strObjective}</td>
...
<script type="text/javascript" src="/PMS/resources/app_srv/PMS/transaction/js/MouCollaboration.js"></script>
